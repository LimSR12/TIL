---
title: "컨트롤러 라우팅 순서로 인해 발생한 Validation failed 에러"
summary: "NestJS에서 정적 라우트(/readme)가 동적 라우트(/:id)보다 나중에 선언되어 발생한 에러 원인 분석과 해결 방법"
status: publish
tag: [NestJS, Backend, Troubleshooting]
category: Backend
---
